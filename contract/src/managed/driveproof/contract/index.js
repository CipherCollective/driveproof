...
const _descriptor_6 = new _SpeedReading_0();
...
class _tuple_0 {
  alignment() {
    return _descriptor_6.alignment().concat(_descriptor_7.alignment().concat(_descriptor_3.alignment()));
  }
  fromValue(value_0) {
    return [
  ...
  toValue(value_0) {
    return _descriptor_6.toValue(value_0[0]).concat(_descriptor_7.toValue(value_0[1]).concat(_descriptor_3.toValue(value_0[2])));
  }
}

const _descriptor_8 = new _tuple_0();

const _descriptor_9 = new __compactRuntime.CompactTypeUnsignedInteger(127n, 1);
...
class _tuple_1 {
  alignment() {
    return _descriptor_9.alignment().concat(_descriptor_10.alignment());
  }
  fromValue(value_0) {
    return [
  ...
  toValue(value_0) {
    return _descriptor_9.toValue(value_0[0]).concat(_descriptor_10.toValue(value_0[1]));
  }
}
...
const _descriptor_14 = new __compactRuntime.CompactTypeBytes(32);

class _Either_0 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_14.alignment().concat(_descriptor_14.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.is_left).concat(_descriptor_14.toValue(value_0.left).concat(_descriptor_14.toValue(value_0.right)));
  }
}
...
class _ContractAddress_0 {
  ...
  fromValue(value_0) {
    return {
      bytes: _descriptor_14.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_14.toValue(value_0.bytes);
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerAttestor: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`registerAttestor: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const attestorId_0 = args_1[1];
        const attestorPk_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerAttestor',
                                     'argument 1 (as invoked from Typescript)',
                                     'driveproof.compact line 26 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(attestorId_0).concat(_descriptor_4.toValue(attestorPk_0)),
        ...
        const result_0 = this._registerAttestor_0(context,
                                                  partialProofData,
                                                  attestorId_0,
                                                  attestorPk_0);
    ...
    this.impureCircuits = {
      registerAttestor: this.circuits.registerAttestor,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('registerAttestor', new __compactRuntime.ContractOperation());
  ...
  _getAttestedSpeedWitness_0(context, partialProofData) {
    ...
    if (!(Array.isArray(result_0) && result_0.length === 3  && typeof(result_0[0]) === 'object' && typeof(result_0[0].speed) === 'bigint' && result_0[0].speed >= 0n && result_0[0].speed <= 65535n && typeof(result_0[1]) === 'object' && true && typeof(result_0[1].response) === 'bigint' && result_0[1].response >= 0 && result_0[1].response <= __compactRuntime.MAX_FIELD && typeof(result_0[2]) === 'bigint' && result_0[2] >= 0n && result_0[2] <= 65535n)) {
      __compactRuntime.typeError('getAttestedSpeedWitness',
                                 'return value',
                                 'driveproof.compact line 20 char 1',
  ...
  _registerAttestor_0(context, partialProofData, attestorId_0, attestorPk_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _proveCompliance_0(context, partialProofData) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('driveproof.compact line 33 char 32: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 65535n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'driveproof.compact line 16 char 1',
                                     'Uint<0..65536>',
                                     key_0)
        }
        return _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
  ...
  schnorrChallenge: (...args_0) => {
    ...
    if (!(typeof(ann_x_0) === 'bigint' && ann_x_0 >= 0 && ann_x_0 <= __compactRuntime.MAX_FIELD)) {
      __compactRuntime.typeError('schnorrChallenge',
                                 'argument 1',
                                 'driveproof.compact line 48 char 1',
                                 'Field',
                                 ann_x_0)
    }
