...
const _descriptor_4 = new __compactRuntime.CompactTypeVector(1, _descriptor_3);
...
class _SpeedReading_0 {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.speed);
  }
}

const _descriptor_5 = new _SpeedReading_0();
...
class _tuple_0 {
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0[0]).concat(_descriptor_6.toValue(value_0[1]).concat(_descriptor_0.toValue(value_0[2])));
  }
}
...
class _SchnorrHashInput_0 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment().concat(_descriptor_4.alignment()))));
  }
  fromValue(value_0) {
    return {
      ...
      msg: _descriptor_4.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.ann_x).concat(_descriptor_3.toValue(value_0.ann_y).concat(_descriptor_3.toValue(value_0.pk_x).concat(_descriptor_3.toValue(value_0.pk_y).concat(_descriptor_4.toValue(value_0.msg)))));
  }
}
...
class _Either_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_14.alignment().concat(_descriptor_14.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.is_left).concat(_descriptor_14.toValue(value_0.left).concat(_descriptor_14.toValue(value_0.right)));
  }
}
...
export class Contract {
      ...
      proveCompliance: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveCompliance',
                                     ...
                                     'driveproof.compact line 27 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _proveCompliance_0(context, partialProofData) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('driveproof.compact line 30 char 32: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
